...
void UI_Controls::InitialiseUI(std::string& fp, unsigned index)
{
...
void UI_Controls::Render(DirectX::SpriteBatch& sb, DirectX::SpriteFont& sf, DirectX::DescriptorHeap* heap)
{
	//Draw frame text
...
UI_Controls::Actions UI_Controls::ProcessInput(char key)
{
	switch (key)
	{
