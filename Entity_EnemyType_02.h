...
/*
	Enemy Type 02 - The FPS player
*/
class Entity_EnemyType_02 : public EM_EntityInterface2D
{
public:
	...
	Entity_EnemyType_02() { Init(); }
	~Entity_EnemyType_02() { Release(); }
...
private:
	...
	DirectX::SimpleMath::Vector2 m_Velocity = { 0, 0 };
	...
	//Tracking timer till the enemy can fire (checked against AttackInterval)
