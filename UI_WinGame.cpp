...
void UI_WinGame::Reset()
{
	m_CurrentIndex = 0;
	m_MenuSelection.SetPosition(m_MenuFrames->GetPosition());
}

void UI_WinGame::InitialiseUI(std::string& fp, unsigned index)
{
...
void UI_WinGame::Render(DirectX::SpriteBatch& sb, DirectX::SpriteFont& sf, DirectX::DescriptorHeap* heap)
{
...
UI_WinGame::Actions UI_WinGame::ProcessInput(char key)
{
	switch (key)
	{
